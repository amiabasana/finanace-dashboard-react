...
function exportTransactionsCsv(rows) {
  ...
  const lines = [
    headers.join(","),
    ...rows.map((t) =>
      [t.date, esc(t.description), esc(t.category), t.type, t.amount].join(","),
    ),
  ];
  ...
  return (
    <div className="mx-auto flex max-w-full flex-col gap-6">
        ...
        <section className="rounded-xl border border-fd-border bg-fd-surface p-4 sm:p-5">
          ...
          >
            ...
            <label className="flex flex-col gap-1 lg:col-span-2">
              ...
              >
                <option value="expense" className="bg-fd-surface">
                  Expense
                </option>
                <option value="income" className="bg-fd-surface">
                  Income
                </option>
              </select>
            </label>
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-xl border border-fd-border bg-fd-glass-5">
          {transactions.length === 0 ? (
            <p className="px-4 py-12 text-center text-sm text-fd-text-muted">
              No transactions yet. Switch to Admin and add one, or use mock
              data.
            </p>
          ) : showEmptyFiltered ? (
            <p className="px-4 py-12 text-center text-sm text-fd-text-muted">
                              ...
                              <td className="px-4 py-2 align-top text-right">
                                <div className="flex flex-col gap-1 sm:flex-row sm:justify-end">
                                  <button
                                    type="button"
                                    onClick={saveEdit}
                                    className="text-xs font-medium text-fd-text-accent hover:underline cursor-pointer"
                                  >
                                    Save
                                  </button>
                                  <button
                                    type="button"
                                    onClick={cancelEdit}
                                    className="text-xs font-medium text-fd-text-muted hover:text-fd-text cursor-pointer"
                                  >
                                    Cancel
                                  </button>
                                </div>
                                ...
                                <td className="px-4 py-3 text-right">
                                  <div className="flex flex-col gap-1 sm:flex-row sm:justify-end sm:gap-3">
                                    <button
                                      type="button"
                                      onClick={() => startEdit(t)}
                                      className="text-xs font-medium text-fd-text-muted hover:text-fd-text-accent cursor-pointer"
                                    >
                                      Edit
                                    </button>
                                    <button
              ...
              <div className="border-t border-fd-border bg-fd-bg-solid/80 px-4 py-4 sm:flex sm:items-center sm:justify-between">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-0">
                  <button
                    ...
                    disabled={page === 1}
                    className="rounded-lg border border-fd-border-light bg-fd-surface px-3 py-1.5 text-xs font-medium text-fd-text-muted transition hover:text-fd-text disabled:cursor-not-allowed disabled:opacity-40 cursor-pointer"
                  >
                    Previous
                  </button>
                  ...
                  <label className="inline-flex items-center gap-2 text-xs text-fd-text-muted">
                    ...
                    <select
                      ...
                      className="rounded-lg border border-fd-border-elevated-50 bg-fd-surface px-2 py-1 text-xs text-fd-text focus:border-fd-border-accent focus:outline-none focus:ring-1 focus:ring-fd-accent cursor-pointer"
                    >
                      {[5, 10, 15, 20].map((size) => (
